...
const systemManage = {
  ...
  /** 权限管理-角色 */
  authrole: createNameComponent(() => import('@/views/main/systemManage/auth/auth-role/index.vue')),
  /** 权限管理-用户 */
  authuser: createNameComponent(() => import('@/views/main/systemManage/auth/auth-user/index.vue')),
  /** 用户 */
