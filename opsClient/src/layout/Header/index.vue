  ...
  <header>
    ...
    <div class="right-box">
      ...
      <div class="function-list">
        ...
        <!-- 中应为切换，配合 中英文的两个system.ts文件实现 -->
        <!-- <div class="function-list-item"><Word /></div> -->
        <!-- 切换文字大小 -->
        <!-- <div class="function-list-item"><SizeChange /></div> -->
        <div class="function-list-item hidden-sm-and-down" v-if="userInfo.level=='SuperAdmin'"><Theme /></div>
        <!-- 跳转到GitHub -->
...
export default defineComponent({
  ...
  setup() {
    ...
    // console.log(import.meta.url,userInfo)
